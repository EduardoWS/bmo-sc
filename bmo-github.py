...
canais_permitidos = [749451565525631026, 754386829360234587, 756134587553284176, 920736410183557142]

# ====== EMBED COMANDOS ======

@client.command(aliases=['help', 'ajudaforca', 'comandos', 'comando', 'ajudacomandos', 'comousar'])
async def ajuda(ctx):
